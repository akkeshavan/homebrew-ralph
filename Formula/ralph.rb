class Ralph < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      ...
      sha256 "85214e019d2611ecac259969af4e6298f760f53b89b1496b1b09f7f40a06a473"
    else
      url "https://github.com/akkeshavan/ralph-releases/releases/download/v#{version}/ralph-v#{version}-x86_64-apple-darwin.tar.gz"
      sha256 "10e021d4e58672170dacaf755130f0c32be603561b962704acf899dd6513765e"
    end
  end
  ...
  on_linux do
    if Hardware::CPU.arm?
      ...
      sha256 "aadb57da4386cac07112f4a67b3345a61df1da72c2eef82e9fcd5478560eb069"
    else
      ...
      sha256 "e95b8d4a2f2b28bcf9342d398cc2d5018e2f4a3a04d56f3f998f1a123e9586c8"
    end
  end
